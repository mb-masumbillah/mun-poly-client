...
import { LucideEyeOff, X } from "lucide-react";
        ...
        <div className="px-12 py-10 space-y-8">
          ...
          <div className="text-center">
            <button
              ...
              className="text-gray-500 underline text-sm cursor-pointer hover:text-gray-700 decoration-gray-400 underline-offset-4"
            >
